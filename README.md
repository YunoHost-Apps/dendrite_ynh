...
**Shipped version:** 0.10.1~ynh1 *(:warning: This is the `ci-auto-update-v0.10.1` branch. The [`master` branch](https://github.com/YunoHost-Apps/dendrite_ynh/tree/master) used in the catalog is currently on version 0.9.9\~ynh3.)*
